...
let SlapHappy = document.getElementById("Slap");
if (SlapHappy)
{
	SlapHappy.addEventListener("click", function() {
	    location.replace("Slap.html")
	});
}

let TankGame = document.getElementById("Tank");
if (TankGame)
{
	TankGame.addEventListener("click", function() {
